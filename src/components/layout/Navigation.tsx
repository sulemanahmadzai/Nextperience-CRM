...
export function Navigation({ currentView, onNavigate }: NavigationProps) {
  const { permissions, currentCompany, companies, switchCompany } =
    useCompany();
  ...
  const navItems = [
    { id: "dashboard", label: "Dashboard", icon: LayoutDashboard, show: true },
    {
      ...
      label: "Customers",
      icon: Users,
      show: !!permissions?.customers?.read,
    },
    {
      id: "leads",
      label: "Leads",
      icon: TrendingUp,
      show: !!permissions?.leads?.read,
    },
    {
      id: "quotations",
      label: "Quotations",
      icon: FileText,
      show: !!permissions?.quotations?.read,
    },
    {
      id: "templates",
      label: "Templates",
      icon: FileType,
      show: !!permissions?.templates?.read,
    },
    {
      id: "products",
      label: "Products",
      icon: Package,
      show: !!permissions?.products?.read,
    },
  ];
